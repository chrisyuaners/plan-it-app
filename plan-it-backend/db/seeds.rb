...
d5 = Destination.create(city: 'London', country: 'United Kingdom')
d6 = Destination.create(city: 'Los Angeles', country: 'United States')
d7 = Destination.create(city: 'San Francisco', country: 'United States')
d8 = Destination.create(city: 'Miami', country: 'United States')
d9 = Destination.create(city: 'Austin', country: 'United States')
d10 = Destination.create(city: 'Taipei', country: 'Taiwan')
